...
// Full caption:
// Center-of-mass postural sway metrics (path length, 95% prediction ellipse
// area, and 2D mean velocity in the horizontal plane) across balance conditions
// for each tracker. Values are reported as group mean ± SD. EO = eyes open,
// EC = eyes closed.
#let balance-metrics = table(
