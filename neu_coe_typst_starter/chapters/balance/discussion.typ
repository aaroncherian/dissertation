...
This work aimed to evaluate the sensitivity of a low-cost markerless motion capture to small balance changes during the Modified Clinical Test of Sensory Interaction on Balance (CTSIB-M) using postural stability metrics calculated from the center of mass (COM). We evaluated sensitivity using three different pose estimation backends in comparison to a marker-based reference. 
