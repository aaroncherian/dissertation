...
Today, markerless tracking of humans has rapidly become the domain of computer vision. In the entertainment space, commercial options are widely accessible (MoveAI, Rokoko Vision, Remocapp). In the research space, multi-camera markerless motion capture systems are typically implemented in one of three forms, reflecting trade-offs in adaptability, accuracy and accessibility.
...
This rest of this work encompasses the development and validation of FreeMoCap, a free open-source motion capture software designed to simultaneously achieve accuracy through advanced computer vision, accessibility through use of low-cost hardware, and adaptability through modular software design.  
