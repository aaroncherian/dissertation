...
This leads to the second question: "How accurate is your system?" Given the wide variety of factors touched upon in this chapter (e.g., camera hardware, number of cameras, pose estimation algorithm choice), I do not believe there is a single answer to this question. The following chapters describe a series of validations of the FreeMoCap software, but rather than providing a single summary metric, I characterize system performance across different movement domains, including dynamic gait, postural stability, and a more complex applied clinical scenario. This approach reflects the view that accuracy is not a single value, but a property that depends on context, task, and the underlying processing choices.
