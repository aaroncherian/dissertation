...
4) *Stride length:* The anterior-posterior distance between the ipsilateral ankle at ipsilateral heel strike and the same ankle at the subsequent ipsilateral heel strike, reported in millimeters (mm). To account for the treadmill, stride length was corrected by adding the distance traveled by the belt. Distance traveled by the belt was computed using the treadmill speed and the time between heel strikes.
